...
<body>
    <div class="wrapper">
        ...
        <div class="box-container" id="formulario">
            ...
            <form action="recebecadastrarItem.php" method="post" name="formulario">
            <h3>Faça o cadastro dos seus itens para emprestar para alguém!</h3>
            <p>Item:
            <input  type="text" name="item" placeholder="Digite o nome do item">
            </p>
            <p>Descrição:</p>
            <p>
             <textarea cols="25" rows="10" name="descricao"></textarea>
            </p>
            
            <p><input type="submit" value=" Cadastrar"></p> <!--check what to do with this input later-->
